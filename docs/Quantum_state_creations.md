...
For example if you want to "work" with electron, which could have 2 possible configuration: **up** and **down**, you can easily write the state and the output will be what you expect 😉:
```python
e = qbit('1|up> +0|down>')
print(e) # +1|up>
print(e.basis)
